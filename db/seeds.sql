...
VALUES('John','Doe','Sales Lead', NULL), ('Mike','Chan','Salesperson','John Doe'), ('Ashley','Rodriguez','Lead Engineer', NULL),('Kevin','Tupik','Softwar Engineer','Ashley Rodriguez'), ('Kunal','Singh','Account Manager', NULL), ('Malia','Brown','Accountant','Kunal Singh'), ('Sarah','Lourd','Legal Team Lead', NULL), ('Tom','Allen','Lawyer','Sarah Lourd'),('Sam','Kash','Sales Lead','Ashley Rodriguez');